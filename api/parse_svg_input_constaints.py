...
def parse_svg(filename: str):
    """
        Parse a SVG file and return a list of Polygon objects based on the SVG paths.
    ...
    for path_string in path_strings:
        ...
        p = Polygon(contour, left_x, bottom_y, right_x-left_x, top_y-bottom_y, margin=space_margin, pid=num_polygons)
        polygons.append(p)
        num_polygons += 1
